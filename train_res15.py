...
from models.dualgcn_res14 import DualGCNClassifier
from models.dualgcn_bert import DualGCNBertClassifier
from data_utils_new import SentenceDataset, build_tokenizer, build_embedding_matrix, Tokenizer4BertGCN, ABSAGCNData
...
def main():
    ...
    dataset_files = {
        ...
        'restaurant15': {
            'train': './dataset/Restaurants_corenlp15/train.json',
            'test': './dataset/Restaurants_corenlp15/test.json',
        },
        'restaurant16': {
            'train': './dataset/Restaurants_corenlp16/train.json',
            'test': './dataset/Restaurants_corenlp16/test.json',
        },
		'NAMS': {
            'train': './dataset/NAMS_corenlp/train.json',
            'test': './dataset/NAMS_corenlp/test.json',
        }
    }
    ...
    parser.add_argument('--dataset', default='restaurant15', type=str, help=', '.join(dataset_files.keys()))
    ...
    parser.add_argument('--gcn_dropout1', type=float, default=0.7, help='GCN layer dropout rate.')
    ...
    parser.add_argument('--rnn_dropout', type=float, default=0.3, help='RNN dropout rate.')
    ...
    parser.add_argument('--vocab_dir', type=str, default='./dataset/Restaurants_corenlp15')
    parser.add_argument('--pad_id', default=0, type=int)
    parser.add_argument('--parseadj', default=True, action='store_true', help='dependency probability')
    ...
    log_file = '{}-{}-{}.log'.format(opt.model_name, opt.dataset, strftime("%Y_%m_%d_%H_%M_%S", localtime()))
