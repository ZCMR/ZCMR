...
class Instructor:
    ...
    def _train(self, criterion, optimizer, max_test_acc_overall=0):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            logger.info('epoch: {:.4f}, max_test: {:.4f}:'.format(epoch,max_test))
...
def main():
    ...
    parser.add_argument('--dataset', default='restaurant16', type=str, help=', '.join(dataset_files.keys()))
    ...
    parser.add_argument('--gcn_dropout1', type=float, default=0.4, help='GCN layer dropout rate.')
    ...
    parser.add_argument('--vocab_dir', type=str, default='./dataset/Restaurants_corenlp16')
