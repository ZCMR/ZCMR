...
python ./DualGCN/prepare_vocab.py --data_dir DualGCN/dataset/Restaurants_corenlp16 --vocab_dir DualGCN/dataset/Restaurants_corenlp16
python ./DualGCN/prepare_vocab.py --data_dir DualGCN/dataset/NAMS_corenlp --vocab_dir DualGCN/dataset/NAMS_corenlp
python ./DualGCN/prepare_vocab.py --data_dir DualGCN/dataset/Restaurants_corenlp15 --vocab_dir DualGCN/dataset/Restaurants_corenlp15
