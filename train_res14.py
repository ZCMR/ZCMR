...
def main():
    ...
    parser.add_argument('--gcn_dropout', type=float, default=0.8, help='GCN layer dropout rate.')
    parser.add_argument('--gcn_dropout1', type=float, default=0.8, help='GCN layer dropout rate.')
