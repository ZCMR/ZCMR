...
from models.dualgcn_laptop import DualGCNClassifier
...
def main():
    ...
    parser.add_argument('--gcn_dropout1', type=float, default=0, help='GCN layer dropout rate.')
    ...
    parser.add_argument('--rnn_dropout', type=float, default=0.6, help='RNN dropout rate.')
